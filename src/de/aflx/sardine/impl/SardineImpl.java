...
//				CoreConnectionPNames.CONNECTION_TIMEOUT, 1000);
	...
	public List<DavResource> list(String url, int depth) throws IOException {
		...
		entity.setEntity(new StringEntity("<?xml version=\"1.0\" encoding=\"utf-8\" ?><D:propfind xmlns:D=\"DAV:\"><D:prop><D:displayname/><D:getcontenttype/><D:getetag/><D:getlastmodified/><D:getcontentlength/><D:creationdate/><D:resourcetype/></D:prop></D:propfind>", UTF_8));
		//entity.setEntity(new StringEntity("PROPFIND / HTTP/1.1", UTF_8));
