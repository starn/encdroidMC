...
//		return params;
	...
	public boolean exists(String s) throws IOException {
		System.out.println("test if exist: "+getAbsolutePath(s));
	...
	public List<EncFSFileInfo> fsList(String s) throws IOException {
		System.out.println("list files: "+getAbsolutePath(s));
