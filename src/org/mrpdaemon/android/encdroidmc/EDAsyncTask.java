...
public abstract class EDAsyncTask<Params, Progress, Result> extends
	...
	protected NotificationHelper myDialog;

	// The activity for this task
	private Activity myActivity = null;

	public NotificationHelper getProgressDialog() {
		return myDialog;
	}

	public void setProgressDialog(NotificationHelper dialog) {
	...
	public void incrementProgressBy(long diff) {
		if (myDialog != null) {
