...
public class EDFileChooserItem implements Comparable<EDFileChooserItem> {
	...
	public EDFileChooserItem(String name, boolean isDirectory, String path, long size, Bitmap icon) {
		this.name = name;
	...
	public EDFileChooserItem(String name, boolean isDirectory, EncFSFile file, long size, Bitmap icon) {
		this.name = name;
		this.isDirectory = isDirectory;
		this.path = null;
		this.size = size;
