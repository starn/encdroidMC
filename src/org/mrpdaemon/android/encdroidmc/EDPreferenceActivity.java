...
public class EDPreferenceActivity extends PreferenceActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Preference button = (Preference)findPreference(getString(R.string.setApplicationPinCode));
		button.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
		                @Override
		                public boolean onPreferenceClick(Preference preference) {
		        			Intent pinCode = new Intent(EDPreferenceActivity.this, PinCodeActivity.class);
		        			pinCode.putExtra("context", "create");
		        			startActivity(pinCode);
		                    return true;
		                }
		            });
		
		Preference button2 = (Preference)findPreference(getString(R.string.setSyncRules));
		button2.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
		                @Override
		                public boolean onPreferenceClick(Preference preference) {
		        			Intent syncActivity = new Intent(EDPreferenceActivity.this, ConfigSyncActivity.class);
