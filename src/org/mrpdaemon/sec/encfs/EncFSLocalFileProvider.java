 ...
 */
public class EncFSLocalFileProvider implements EncFSFileProvider,Serializable {
...
//		System.out.println("check if exists: "+(new File(rootPath.getAbsoluteFile(), srcPath)).getAbsolutePath());
		boolean result =  new File(rootPath.getAbsoluteFile(), srcPath).exists();
//		System.out.println("result="+result);
	 ...
	 */
	public InputStream openInputStream(String srcFilePath, long startIndex)
