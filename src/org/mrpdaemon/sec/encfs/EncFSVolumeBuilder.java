...
public final class EncFSVolumeBuilder {
	...
	public static class FileProviderBuilder {
		...
		public FileProviderBuilder(EncFSVolume volume, String rootPath) {
			this(volume, new EncFSLocalFileProvider(new File(rootPath)),"noname");
		}

		public FileProviderBuilder(EncFSVolume volume,EncFSFileProvider fileProvider, String volumeName) {
			this.volume = volume;
	...
	public FileProviderBuilder withFileProvider(EncFSFileProvider fileProvider, String volumeName) {
		return new FileProviderBuilder(new EncFSVolume(), fileProvider,volumeName);
	}
}
