...
public class StreamCrypto {
	...
	private synchronized static byte[] streamDecrypt(Cipher cipher, Mac mac, Key key,
	 ...
	 */
	public synchronized static byte[] computeChainIv(EncFSVolume volume, String volumePath) {
